  ...
  public:
    ...
    virtual AFF4Status RegisterArgs() {
        ...
        AddArg(new TCLAP::MultiArgToNextFlag(   // CUSTOM metadata file argument
                ...
                "these images needs to be included with the metadata to ensure correct identification. "
                "Multiple independent metadata sets may be specified in one file. If a set of "
                "metadata cannot be connected to a corresponding file, this set will be added as "
                "independent metadata to information.turtle. The RDF metadata file will be processed last "
                " if paired with -i.",
                false, "/path/to/file/or/device"));
