...
class DataStore {
  ...
  public:
    ...
    /* Returns the value of the attribute as string if available, else returns NOT_FOUND*/    
    virtual std::string GetAttributeValue(const URN& urn, const URN& attribute) =0;
...
class MemoryDataStore: public DataStore {
  ...
  public:
    ...
    std::string GetAttributeValue(const URN& urn, const URN& attribute) override;
