                                   ...
                                   for (std::string aff4Type : aff4Types) {
                                       ...
                                       //    std::cout << "process_metadataFiles metadataFiltered: " << "\n" << metadataFiltered << "\n";
                                           ...
                                           //else resolver.Set(testURN, AFF4_STREAM_UNKNOWN, new XSDString(metadataFiltered), true); 
                                               ...
                                               /*(aff4Type == "ComputerName") != std::string::npos) resolver.Set(testURN, AFF4_STREAM_TIMESTAMP, new XSDString(metadataFiltered), true);
